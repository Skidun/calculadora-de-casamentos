$(document).ready(function (){
	...
	$("#executarCadItem").click(function (){
		...
		if(nomeItem != ''){
			$("#formCadItem").slideUp();
			$(".lightbox-item .inside").append('<center><img src="img/loader.gif" align="center" /></center><p align="center">Aguarde...</p>');
			...
			$.getJSON("functions/insertItem.php", {nomeItem:nomeItem, orcamento:orcamentoItem}, function(x){
					...
					$(".lightbox-item .inside").append('<center><h1>Cadastrado com sucesso</h1></center>').fadeIn(1000);
	...
	$('#executarCadSubItem').click(function (){
		...
		$(".lightbox-subitem .inside").append('<center><img src="img/loader.gif" align="center" /></center><p align="center">Aguarde...</p>');
		...
		$.getJSON("functions/insert.php", {nomeSubItem:nomeSubItem, itemID:itemSubItem}, function(x){
					...
					$(".lightbox-subitem .inside").append('<center><h1>Cadastrado com sucesso</h1></center>').fadeIn(1000);
	...
	$('#formEditItem #executarEditItem').click(function(e){
	   e.preventDefault();
		...
		if(nomeDoItem != '' || orcamentoDoItem != ''){
			...
			$(".lightbox-editar .inside").append('<center><img src="img/loader.gif" align="center" /></center><p align="center">Aguarde...</p>');
			$.getJSON("functions/updateEditItem.php", {nomeDoItem:nomeDoItem, orcamentoDoItem:orcamentoDoItem, idDoItem:idDoItem}, function(x){
					...
					$(".lightbox-editar .inside").append('<center><h1>Editado com sucesso</h1></center>').fadeIn(1000);
	...
	$('#formEditSubItem #executarEditSubItem').click(function (){
		...
		if(nomeSubItem != ''){
			...
			$(".lightbox-subitem-editar .inside").append('<center><img src="img/loader.gif" align="center" /></center><p align="center">Aguarde...</p>');
			$.getJSON("functions/updateEditSubItem.php", {id:idSubItem, nome:nomeSubItem}, function(x){
				...
				$(".lightbox-subitem-editar .inside").append('<center><h1>Editado com sucesso</h1></center>').fadeIn(1000);
				setTimeout("location.reload();", 1000);
				});
	...
	$('#executarDeleteSubItem').click(function(){
		...
		$(".lightbox-excluir-subitem .inside").append('<center><img src="img/loader.gif" align="center" /></center><p align="center">Aguarde...</p>');
		$.getJSON("functions/deleteExcluiSubItem.php", {id:id}, function(x){});
			setTimeout('$(".lightbox-excluir-subitem, center, img, p").fadeOut(500);$(".lightbox-excluir-subitem .inside").append("<center><h1>Subitem e fornecedores excluidos com sucesso</h1></center>").fadeIn(1000);', 2000);
			setTimeout('window.location.href="index.php";', 1000);		
		});
	...
	$('#executarCadFornecedor').click(function(){
		...
		if(nomeFornecedor != '' && valorFornecedor != ''){
		$("#formCadFornecedor").slideUp();
		$(".lightbox-fornecedor .inside").append('<center><img src="img/loader.gif" align="center" /></center><p align="center">Aguarde...</p>');
		...
		setTimeout('$(".lightbox-fornecedor, center, img, p").fadeOut(500);$(".lightbox-fornecedor .inside").append("<center><h1>Cadastrado com sucesso</h1></center>").fadeIn(1000);', 3000);
		setTimeout("location.reload();", 4000);
		}else{
		  alert("O campo nome e valor são obrigatório");
		}
		});
	//Editar Fornecedor
	...
	$('#executarEditFornecedor').click(function(){
		...
		$(".lightbox-fornecedor-editar .inside").append('<center><img src="img/loader.gif" align="center" /></center><p align="center">Aguarde...</p>');
		...
		$.getJSON("functions/updateEditFornecedor.php",{id:idFEditar, nomeFornecedor:nomeFEditar, contatoFornecedor:contatoFEditar, emailFornecedor:emailFEditar, valorFornecedor:valorFEditar, obsFornecedor:obsFEditar}, function(y){
			...
			$('.lightbox-fornecedor-editar .inside').append('<p align="center">'+sucesso+'</p>');
	...
	$('#executarIndicar').click(
		function(){
			...
			$(".lightbox-indique-fornecedor .inside").append('<center><img src="img/loader.gif" align="center" /></center><p align="center">Aguarde...</p>');
			...
			$.getJSON(
				...
				function(x){
					...
					$(".lightbox-indique-fornecedor .inside").append("<center><h1>"+msg+"</h1></center>").fadeIn(1000);
					setTimeout('location.reload();', 3000);
					}
			);
		});
	...
	$('.excluir-fornecedor').click(function(){
		var id	=	$(this).attr('rel');
        //alert(id);
        $("#formExcluiFornecedor").append("<input type='hidden' id='idDoFornecedor' value='"+id+"' />");
		$('#executarDeleteFornecedor').click(function(){			
		$("#formExcluiFornecedor, p").slideUp();
		$(".lightbox-excluir-fornecedor .inside").append('<center><img src="img/loader.gif" align="center" /></center><p align="center">Aguarde...</p>');
		var idForn = $("#idDoFornecedor").val();
        $.getJSON("functions/deleteExcluiFornecedor.php", {id:idForn}, 
			function(x)
			{
				var subitem = x.subitem;
				setTimeout('$(".lightbox-excluir-fornecedor center, img, p").fadeOut(500);$(".lightbox-excluir-fornecedor .inside").append("<center><h1>Fornecedor excluido com sucesso</h1></center>").fadeIn(1000);', 3000);
	...
	$('.cancelar-negocio').click(function(){
		...
		$.getJSON("functions/updateCancelarFornecedor.php", {id:id, subitem:subitem},function(x){setTimeout('window.location.href="index.php?idSubItem='+subitem+'&fornecedor=true"', 2000);	});
		...
		function()
			{
				...
				if(perfilNome == '' || perfilData == ''){
					...
					setTimeout('$("#alerta-erro-form").fadeOut(2000);', 4000);
                        ...
                        $('.indicacao').remove();
						$('#lightbox12 .inside').append('<center><img src="img/loader.gif" align="center" /></center><p id="aguarde" align="center">Aguarde...</p>');	
						$.getJSON("functions/updatePerfil.php", {perfilEmail:perfilEmail, perfilNome:perfilNome, perfilData:perfilData}, 
							function(x){
								...
								$('#lightbox12 .inside').append('<br /><p>'+sucesso+'</p>');
								setTimeout('location.reload();', 3000);
								});
						}
			}
		...
		function(){
			...
			if(relatorioNome == '' || relatorioEmail == ''){
				...
				setTimeout('$("#alerta-erro-form").fadeOut(1000)', 4000);
					...
					$('#lightbox10 .inside').append('<center><img src="img/loader.gif" align="center" /></center><p id="aguarde" align="center">Aguarde...</p>');
					$.getJSON("functions/sendReport.php",{relatorioNome:relatorioNome, relatorioEmail:relatorioEmail}, function(x){
							...
							$('#lightbox10 .inside').append('<p>Enviado com Sucesso</p>');
							setTimeout('location.reload();', 3000);
							});
	...
	//
    $('#close-percentual').click(
        function(){
            $.getJSON("functions/updatePercent.php");
        }
    );
